<?php
    ...
    // Post Types
    include_once 'setup/cpt-cards.php';
    include_once 'setup/cpt-heroes.php';
    include_once 'setup/cpt-partners.php';

    // Taxonomies
    include_once 'setup/tax-highlights.php';
    ...
    function header_menus( $data ) {
        ...
        $data["social_menu"] = new TimberMenu('social');
        $data["topics_menu"] = new TimberMenu('topics');
    ...
    function global_variables( $data ) {
        ...
        $data["gv"]["twitter_id"] = "Saving_The_West";
        // $data["gv"]["ga_id"] = "";
        // $data["gv"]["fb_app_id"] = "";
        // $data["gv"]["gtm_id"] = "";
